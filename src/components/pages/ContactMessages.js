...
function ContactMessages() {
    ...
    const deleteClick = async (value) => {
      ...
      if (shouldDelete) {
        ...
        axios.post(apiUrl+'api/site-info-get-contact-messages-delete', article, {
          headers: {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const response = await axios.post(apiUrl+'api/site-info-get-contact-messages', data, {
          headers: {
            Authorization: token
          }
        });
      ...
      {loading ? (
            ...
            <main className="dash-content">
                ...
                <div className="col-lg-6">
                  <h1 className="dash-title">All Contact Messages Posts</h1>
                  <ToastContainer
                      position="top-right"
                      autoClose={5000}
                      hideProgressBar={false}
